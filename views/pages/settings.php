    ...
    <section class="settings">
        <div class="container">
            ...
            <form class="settings__password settings_hidden" action="/change-password" method="post">
                ...
                <input type="hidden" name="csrf_token" value="<?php echo $csrfToken; ?>">
                <input type="hidden" name="u" value="<?php echo $userName; ?>">
                <?php $view->component('input', ['id' => 'change-password-password-input', 'type' => 'password', 'name' => 'old_password', 'placeholder' => 'Старый пароль*', 'value' => $session->getFlush('old_password_value')]) ?>
                <?php $view->component('validation-message', ['id' => 'change-password-password-error', 'inputName' => 'old_password']); ?>
                <?php $view->component('input', ['id' => 'change-password-new-password-input', 'type' => 'password', 'name' => 'new_password', 'placeholder' => 'Новый пароль*', 'value' => $session->getFlush('new_password_value')]) ?>
                <?php $view->component('validation-message', ['id' => 'change-password-new-password-error', 'inputName' => 'new_password']); ?>
                <?php $view->component('input', ['id' => 'change-password-new-password-confirmation-input', 'type' => 'password', 'name' => 'new_password_confirmation', 'placeholder' => 'Еще раз новый пароль*', 'value' => $session->getFlush('new_password_confirmation_value')]) ?>
    ...
    <div class="delete-account-popup" id="delete-account-popup">
        <div class="delete-account-popup__content">
            ...
            <form id="deleteAccountForm" action="/delete-account" method="post">
                ...
                <?php $view->component('input', ['id' => 'delete-account-password-input', 'type' => 'password', 'name' => 'password', 'placeholder' => 'Пароль*', 'value' => $session->getFlush('password_value')]) ?>
