        ...
        <div class="container">
            <form class="credentials__form" id="signInForm" action="/signin" method="post">
                ...
                <div class="credentials__container">
                    <?php $view->component('input', ['id' => 'signin-name-input', 'type' => 'text', 'name' => 'name', 'placeholder' => 'Имя*', 'value' => $this->session->getFlush('name_value')]) ?>
                    <?php $view->component('validation-message', ['id' => 'signin-name-error', 'inputName' => 'name']); ?>
                    <?php $view->component('input', ['id' => 'signin-password-input', 'type' => 'password', 'name' => 'password', 'placeholder' => 'Пароль*', 'value' => $this->session->getFlush('password_value')]) ?>
            ...
            <form class="credentials__form credentials__form_hidden" id="forgotNameForm" action="/forgot-name" method="post">
                ...
                <input type="hidden" name="csrf_token" value="<?php echo $csrfToken; ?>">
                <div class="credentials__container">
                    <?php $view->component('input', ['id' => 'forgot-name-email-input', 'type' => 'email', 'name' => 'email', 'placeholder' => 'E-mail*', 'value' => $this->session->getFlush('email_value')]) ?>
            ...
            <form class="credentials__form credentials__form_hidden" id="forgotPasswordForm" action="/forgot-password" method="post">
                ...
                <input type="hidden" name="csrf_token" value="<?php echo $csrfToken; ?>">
                <div class="credentials__container">
                    <?php $view->component('input', ['id' => 'forgot-password-name-input', 'type' => 'text', 'name' => 'forgot-password_name', 'placeholder' => 'Имя*', 'value' => $this->session->getFlush('forgot-password_name_value')]) ?>
